                ...
                >
                    ...
                    <Form>
                        ...
                        <Messages>
                            <div style={{
                                ...
                                <ErrorsMessages>
                                    ...
                                    <p>
                                        Nome de usuário inválido:<br/>
                                        - deve estar entre 2 a 32 caracteres.
                                    </p>}
                        ...
                        </Messages>
                        {
                            ...
                            validateEmail(email) && 
                            validatePassword(password) 
                            ? <StyledButton onClick={() => createUserWithEmailAndPassword(email, password)}>Entrar</StyledButton> : <StyledButton disabled>Entrar</StyledButton>
                        }
                    </Form>
                </Box>
            </Content>
