...
export const Content = styled.div`
  ...
  background-image: linear-gradient(
    ...
    ${(props) => shade(0.9, props.theme.colors.secondaryScreenGradient)}
  );
...
export const Box = styled(motion.div)`
  ...
  background-color: ${(props) =>
    transparentize(0.4, shade(0.8, props.theme.colors.primary))};
  padding: 10px;
  border-radius: 10px;
  box-shadow: 0 0 20px 0
    ${(props) => transparentize(0.8, props.theme.colors.shadow)};
`
